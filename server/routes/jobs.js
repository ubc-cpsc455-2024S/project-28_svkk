...
router.post('/tag/:filters', async function(req, res, next) {
  ...
  // took help from stackoverflow to for the syntax for filtering by 
  // whether the array contains a specific member. 
  // Link: https://stackoverflow.com/questions/18148166/find-document-with-array-that-contains-a-specific-value
